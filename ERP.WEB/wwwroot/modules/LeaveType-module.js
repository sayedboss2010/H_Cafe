...
$(document).on('click', '.btnAdd', function (e) {
    ...
    $('#LeaveTypeId').val(0);
    $("#addLeaveTypeModal").appendTo('body').modal("show");
});
...
$(document).on('click', '#btnAddEditUniv', function (e) {
    ...
    let uri = id == 0 ? '/LeaveType/Add?arName=' + arName + '&enName=' + enName + '&facs=' + facs
        : '/LeaveType/Edit?id=' + id + '&arName=' + arName + '&enName=' + enName + '&facs=' + facs;
...
$(document).on('click', '.btnPrint', function () {
    ...
    $.ajax({
        url: '/LeaveType/PrintData?term=' + term,
        async: true,
        success: function (result) {
...
//***********************************************************************/
function LoadIndex() {
    let uri = '/LeaveType/Index';

    let term = $('#SearchString').val();
    if (term != "") {
        uri = '/LeaveType/Search?term=' + term;
    }
