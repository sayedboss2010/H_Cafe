...
$(document).on('click', '#btnAddEditUniv', function (e) {
    ...
    let uri = id == 0 ? '/Country/Add?arName=' + arName + '&enName=' + enName + '&facs=' + facs
        : '/Country/Edit?id=' + id + '&arName=' + arName + '&enName=' + enName + '&facs=' + facs;
...
$(document).on('click', '.btnPrint', function () {
    ...
    $.ajax({
        url: '/Country/PrintData?term=' + term,
        async: true,
        success: function (result) {
...
//***********************************************************************/
function LoadIndex() {
    let uri = '/Country/Index';

    let term = $('#SearchString').val();
    if (term != "") {
        uri = '/Country/Search?term=' + term;
    }
