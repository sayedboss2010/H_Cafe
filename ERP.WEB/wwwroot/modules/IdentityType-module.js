...
$(document).on('click', '.btnModalClose', function () {
    $("#addIdentityTypeModal").modal("hide");
});
...
$(document).on('click', '.btnAdd', function (e) {
    ...
    $("#addIdentityTypeModal").appendTo('body').modal("show");
});
...
$(document).on('click', '.edit-btn', function (e) {
    ...
    $.ajax({
        url: '/IdentityType/GetById?id=' + id,
        async: true,
...
$(document).on('click', '#btnAddEditUniv', function (e) {
    ...
    let uri = id == 0 ? '/IdentityType/Add?arName=' + arName + '&enName=' + enName + '&facs=' + facs
        : '/IdentityType/Edit?id=' + id + '&arName=' + arName + '&enName=' + enName + '&facs=' + facs;
...
$(document).on('click', '.btnPrint', function () {
    ...
    $.ajax({
        url: '/IdentityType/PrintData?term=' + term,
        async: true,
        success: function (result) {
...
//***********************************************************************/
function LoadIndex() {
    let uri = '/IdentityType/Index';

    let term = $('#SearchString').val();
    if (term != "") {
        uri = '/IdentityType/Search?term=' + term;
    }
