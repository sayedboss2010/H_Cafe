...
namespace Cafe.WEB.Controllers
{
    public class MenuCafeController : Controller
    {
        ...
        //[HttpPost]
        //public IActionResult SubmitOrder(List<OrderItemViewModel> items)
        //{
        //    var selectedItems = items.Where(i => i.Quantity > 0).ToList();

        //    // مثال على الحفظ:
        //    foreach (var item in selectedItems)
        //    {
        //        // احفظ في قاعدة البيانات مثلاً:
        //        Console.WriteLine($"الصنف: {item.SubcategoryId}, الكمية: {item.Quantity}");
        //    }
