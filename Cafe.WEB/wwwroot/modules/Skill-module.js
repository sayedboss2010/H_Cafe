...
$(document).on('click', '.btnAdd', function (e) {
    ...
    $('#SkillsId').val(0);
    $("#addSkillsModal").appendTo('body').modal("show");
});
...
$(document).on('click', '#btnAddEditUniv', function (e) {
    ...
    let uri = id == 0 ? '/Skills/Add?arName=' + arName + '&enName=' + enName + '&facs=' + facs
        : '/Skills/Edit?id=' + id + '&arName=' + arName + '&enName=' + enName + '&facs=' + facs;
...
$(document).on('click', '.btnPrint', function () {
    ...
    $.ajax({
        url: '/Skills/PrintData?term=' + term,
        async: true,
        success: function (result) {
...
//***********************************************************************/
function LoadIndex() {
    let uri = '/Skills/Index';

    let term = $('#SearchString').val();
    if (term != "") {
        uri = '/Skills/Search?term=' + term;
    }
